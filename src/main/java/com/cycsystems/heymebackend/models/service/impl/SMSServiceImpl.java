...
public class SMSServiceImpl {
	...
	public Message sendSMS(Integer idEmpresa, String to, String smsMessage) {
		...
		String accountSid = this.parametroService.findParameterByEmpresaAndName(idEmpresa, Constants.ACCOUNT_SID)
				.getValor();
		String authToken = this.parametroService.findParameterByEmpresaAndName(idEmpresa, Constants.AUTH_TOKEN)
				.getValor();
		String serviceId = this.parametroService.findParameterByEmpresaAndName(idEmpresa, Constants.SERVICE_ID)
				.getValor();
		...
		Message message = Message.creator(new PhoneNumber(to), serviceId, smsMessage).create();
	...
	public String sendWhatsapp(Integer idEmpresa, String to, String txtMessage) {
		...
		String authToken = this.parametroService.findParameterByEmpresaAndName(idEmpresa, Constants.AUTH_TOKEN)
				.getValor();
		// String serviceId =
		// this.parametroService.findParameterByEmpresaAndName(idEmpresa,
		// Constants.SERVICE_ID).getValor();
		...
		Message message = Message
				.creator(new PhoneNumber("whatsapp:+17033489896"), new PhoneNumber("whatsapp:" + to), txtMessage)
				.create();
	...
	public static void main(String[] args) {
		...
		Message message = Message.creator(new PhoneNumber("whatsapp:+50255742084"),
				"MGca0f5a07c33c3663c04e712b687b1d80", "Su código c y c systems guatemala es 12345").create();
